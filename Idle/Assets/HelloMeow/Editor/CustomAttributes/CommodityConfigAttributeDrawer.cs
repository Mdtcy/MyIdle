...
{
    [CustomPropertyDrawer(typeof(CommodityConfigAttribute))]
    public class CommodityConfigAttributeDrawer : PropertyDrawer
    {
        /// <summary>
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (idHash == 0) idHash = "CommodityConfigDrawer".GetHashCode();
        ...
        private static void FetchAllConfigs(bool force = false)
        {
            ...
            foreach (var guid in AssetDatabase.FindAssets("t:CommodityConfig"))
            {
