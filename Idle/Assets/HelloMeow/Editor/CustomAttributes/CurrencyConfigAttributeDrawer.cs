...
{
    [CustomPropertyDrawer(typeof(CurrencyConfigAttribute))]
    public class CurrencyConfigAttributeDrawer : PropertyDrawer
    {
        /// <summary>
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (idHash == 0) idHash = "CurrencyConfigDrawer".GetHashCode();
        ...
        private static void FetchAllConfigs(bool force = false)
        {
            ...
            foreach (var guid in AssetDatabase.FindAssets("t:CurrencyConfig"))
            {
