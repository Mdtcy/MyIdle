...
{
    [CustomPropertyDrawer(typeof(JumpToShoppingLinkConfigAttribute))]
    public class JumpToShoppingLinkConfigAttributeDrawer : PropertyDrawer
    {
        /// <summary>
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (idHash == 0) idHash = "JumpToShoppingLinkConfigDrawer".GetHashCode();
        ...
        private static void FetchAllConfigs(bool force = false)
        {
            ...
            foreach (var guid in AssetDatabase.FindAssets("t:JumpToShoppingLinkConfig"))
            {
