...
namespace Com.TheFallenGames.OSA.Demos.ContentSizeFitter
{
	...
	/// <para>A "Twin" <see cref="ComputeVisibilityManager{TParams,TItemViewsHolder}.ComputeVisibility(double)"/> pass is executed after the current one has finished (meaning <see cref="UpdateViewsHolder(MyItemViewsHolder)"/> was called for all visible items).</para>
	/// </summary>
