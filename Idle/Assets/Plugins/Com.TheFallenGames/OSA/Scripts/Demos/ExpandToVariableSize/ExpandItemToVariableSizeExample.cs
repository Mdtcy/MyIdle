...
using Com.TheFallenGames.OSA.Demos.ContentSizeFitter;
using Com.TheFallenGames.OSA.Util.Animations;

namespace Com.TheFallenGames.OSA.Demos.ExpandToVariableSize
{
	/// <summary>A list of items similar to the <see cref="ContentSizeFitterExample"/>, but items can be expanded/collapsed</summary>
