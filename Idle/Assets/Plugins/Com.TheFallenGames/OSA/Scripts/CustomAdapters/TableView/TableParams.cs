...
namespace Com.TheFallenGames.OSA.CustomAdapters.TableView
{
	...
	public class TableParams : BaseParams
	{
		...
		public class TableConfig
		{
			...
			/// <summary>A GameObject having a component that implements <see cref="ITableViewFloatingDropdown"/></summary>
			...
			/// <summary>Used for text input. See <see cref="TableViewTextInputController"/></summary>
