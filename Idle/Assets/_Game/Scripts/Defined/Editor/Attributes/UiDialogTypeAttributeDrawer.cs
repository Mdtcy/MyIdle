...
{
    [CustomPropertyDrawer(typeof(UiDialogTypeAttribute))]
    public class UiDialogTypeAttributeDrawer : PropertyDrawer
    {
        /// <summary>
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (idHash == 0) idHash = "UiDialogTypeAttributeDrawer".GetHashCode();
        ...
        private static void FetchAllConfigs(bool force = false)
        {
            ...
            // fetch all names
            var fields = typeof(UiDialogType).GetFields(BindingFlags.Static | BindingFlags.Public);
